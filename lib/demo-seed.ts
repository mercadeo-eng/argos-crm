...
export const DEMO_CLIENTES: Record<string, Cliente> = {
  "acme-corp": {
    ...
    etapas: [
      { etapa: "stage-1", fecha: "2026-05-12", estado: "listo", calId: true },
      { etapa: "stage-2", fecha: "2026-05-19", estado: "listo", calId: true },
      { etapa: "stage-3", fecha: null, estado: "pendiente", calId: false },
      { etapa: "stage-4", fecha: "2026-06-10", estado: "pendiente", calId: true },
      { etapa: "stage-5", fecha: "2026-06-12", estado: "pendiente", calId: true },
    ],
  ...
  "globex": {
    ...
    etapas: [
      { etapa: "stage-1", fecha: null, estado: "pendiente", calId: false },
      { etapa: "stage-2", fecha: null, estado: "pendiente", calId: false },
      { etapa: "stage-3", fecha: null, estado: "pendiente", calId: false },
      { etapa: "stage-4", fecha: "2026-05-22", estado: "pendiente", calId: true },
      { etapa: "stage-5", fecha: "2026-05-23", estado: "pendiente", calId: true },
    ],
  ...
  "initech": {
    ...
    etapas: [
      ...
      { etapa: "stage-2", fecha: null, estado: "pendiente", calId: false },
      { etapa: "stage-3", fecha: null, estado: "pendiente", calId: false },
      { etapa: "stage-4", fecha: "2026-05-26", estado: "pendiente", calId: true },
      { etapa: "stage-5", fecha: "2026-05-30", estado: "pendiente", calId: true },
    ],
  ...
  "hooli": {
    ...
    etapas: [
      { etapa: "stage-1", fecha: "2026-05-13", estado: "listo", calId: true },
      { etapa: "stage-2", fecha: null, estado: "pendiente", calId: false },
      { etapa: "stage-3", fecha: null, estado: "pendiente", calId: false },
      { etapa: "stage-4", fecha: "2026-06-01", estado: "pendiente", calId: true },
      { etapa: "stage-5", fecha: "2026-06-02", estado: "pendiente", calId: true },
    ],
  ...
  "pied-piper": {
    ...
    etapas: [
      { etapa: "stage-1", fecha: null, estado: "pendiente", calId: false },
      { etapa: "stage-2", fecha: "2026-05-09", estado: "listo", calId: true },
      { etapa: "stage-3", fecha: null, estado: "pendiente", calId: false },
      { etapa: "stage-4", fecha: "2026-05-20", estado: "listo", calId: true },
      { etapa: "stage-5", fecha: "2026-05-16", estado: "pendiente", calId: true },
    ],
  ...
  "wayne-ent": {
    ...
    etapas: [
      ...
      { etapa: "stage-2", fecha: null, estado: "pendiente", calId: false },
      { etapa: "stage-3", fecha: null, estado: "pendiente", calId: false },
      { etapa: "stage-4", fecha: "2026-06-02", estado: "pendiente", calId: true },
      { etapa: "stage-5", fecha: "2026-06-03", estado: "pendiente", calId: true },
    ],
    pautas: null,
  },
  "stark-ind": {
    ...
    etapas: [
      { etapa: "stage-1", fecha: null, estado: "pendiente", calId: false },
      { etapa: "stage-2", fecha: null, estado: "pendiente", calId: false },
      { etapa: "stage-3", fecha: "2026-05-07", estado: "listo", calId: true },
      { etapa: "stage-4", fecha: "2026-05-14", estado: "listo", calId: true },
      { etapa: "stage-5", fecha: "2026-05-22", estado: "listo", calId: true },
    ],
  ...
  "massive-dyn": {
    ...
    etapas: [
      { etapa: "stage-1", fecha: null, estado: "pendiente", calId: false },
      { etapa: "stage-2", fecha: "2026-05-04", estado: "listo", calId: true },
      { etapa: "stage-3", fecha: null, estado: "pendiente", calId: false },
      { etapa: "stage-4", fecha: "2026-05-15", estado: "listo", calId: true },
      { etapa: "stage-5", fecha: "2026-05-11", estado: "listo", calId: true },
    ],
